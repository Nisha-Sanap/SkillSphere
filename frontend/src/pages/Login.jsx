    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-50 px-4">
      ...
      >
        ...
        <div className="bg-white rounded-3xl p-8 shadow-xl border border-slate-100">
          ...
          <p className="text-slate-500 text-center mb-10">Sign in to your account to continue</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between text-sm">
              <label className="flex items-center gap-2 cursor-pointer">
                <input type="checkbox" className="w-4 h-4 rounded-md border-slate-300 text-primary-600 focus:ring-primary-600" />
                <span className="text-slate-600">Remember me</span>
              </label>
              <a href="#" className="text-primary-600 font-semibold hover:underline">Forgot?</a>
            </div>
